...
def folder_checker(args):
    new_path='D:\React\pembada-second\public\%s'%args
    os.chdir('D:\React\pembada-second\public')
...
def deletealbum(id):
    ...
    print(result.id)
    newpath='D:\React\pembada-second\public\%s'%result.name
    os.chdir('D:\React\pembada-second\public')
    shutil.rmtree(r'D:\React\pembada-second\public\%s'%result.name)
...
def deletefile(id):
    ...
    os.chdir('D:\React\pembada-second\public')
    os.remove('D:\React\pembada-second\public\%s'%new_filepath)
    db.session.delete(result)
    db.session.commit()
    return({'status':'deleted sucessfully'})
